...
import pattern.factory.FileParser;
import pattern.factory.FileParserFactory;
import priv.lz.designapplication.R;
import priv.lz.designapplication.TTSSettingActivity;
/**
 * @author lizan
 */
...
//        permissionsList.add(Manifest.permission.READ_MEDIA_AUDIO);
    ...
    public void parseFile(Uri uri, int type) {
        ...
        FileParser parser = factory.createFileParser(type);
        String content = parser.parseFile(uri, TTSActivity.this);
